// Executive Command Center — READ-ONLY executive analytics for admins.
// KPIs, department leaderboard, AI predictions, and hotspot heatmap.
// Operational actions (escalation, per-report inspector, status changes)
...
import { refreshAdminPredictions } from "@/lib/admin-ai.functions";
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <Button asChild variant="ghost" size="sm" className="mb-2">
            <Link to="/admin"><ArrowLeft className="mr-1 h-3.5 w-3.5" /> Admin Panel</Link>
          </Button>
          ...
          <p className="text-sm text-muted-foreground">Read-only executive view: KPIs, department performance, AI insights, and hotspots.</p>
        </div>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <Card className="p-5">
          ...
          <p className="mt-3 border-t border-border pt-3 text-[11px] text-muted-foreground">
            Per-report AI inspector lives in the <Link to="/admin" className="underline">Admin Panel</Link>.
          </p>
        </Card>
      </div>
